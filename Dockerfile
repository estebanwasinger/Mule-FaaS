...
RUN wget https://github.com/estebanwasinger/Mule-FaaS/releases/download/0.0.6/mule-faas-0.0.6-SNAPSHOT.jar

ENV PORT=8081

CMD ["java", "-jar","-Dserver.port=${PORT}", "mule-faas-0.0.6-SNAPSHOT.jar"]